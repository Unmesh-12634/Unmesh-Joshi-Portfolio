...
import { BookOpen, Code, Rocket, Brain, Sparkles, Users, Server, Trophy, Lightbulb, Award } from 'lucide-react';
...
export function Journey() {
  ...
  const roadmapItems = [
    ...
    },
    {
      ...
      icon: Award,
      description: 'Selected as a HackerRank Campus Ambassador, representing HackerRank at my university and helping to build a strong coding community.',
      highlights: [
        'Became a HackerRank Campus Ambassador on November 1, 2025',
        'Hosted coding events and workshops',
