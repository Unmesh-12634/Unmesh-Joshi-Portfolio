...
import { Award, BookOpen, Trophy, ExternalLink, Briefcase, X } from 'lucide-react';
...
export function Certificates() {
  ...
  const hackathons = [
    ...
    {
      title: 'Hack With UP',
      organizer: 'Chitkara University, Lucknow',
      description: 'Participated in Hack With UP, a competitive hackathon with over 15,000 registrations. Achieved a position in the top 300, showcasing strong problem-solving and development skills.',
      achievement: 'Top 300 Position',
      image: '/Hackathons/Hack With UP.png',
      date: '2025',
    },
    {
      title: 'SUNHACKS-2K25',
