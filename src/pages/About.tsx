          ...
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            <Card glowColor="secondary">
              ...
              <p className="text-foreground/90 leading-relaxed">
                ...
                <span className="text-[#7c4dff] font-semibold">Techno India NJR, Udaipur</span>, and a <span className="text-[#00e5ff] font-semibold">HackerRank Campus Ambassador</span>, 
